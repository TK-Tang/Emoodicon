                ...
                <ul class="user-menu">
                    <li class="dropdown pull-right">
                        ...
                        <ul class="dropdown-menu" role="menu">
                                                    <li><a href="${pageContext.request.contextPath}/calendar/${currentProject.id}"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"/></svg> Calendar</a></li>
